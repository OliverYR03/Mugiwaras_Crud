...
ALTER TABLE reseñas ADD FOREIGN KEY (idcliente) REFERENCES clientes (idclientes);
ALTER TABLE reseñas ADD FOREIGN KEY (idplato) REFERENCES platos (idplato);
...
INSERT INTO platos (nombre, descripcion, precio, tipoplato, imagen) VALUES
 ...
 INSERT INTO reseñas (idplato, idcliente, calificacion, comentario, fecha) VALUES
